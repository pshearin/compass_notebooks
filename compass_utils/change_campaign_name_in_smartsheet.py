...
compass_tracker_filename = 'Consolidated Report View_20200722.xlsx'
...
sheet_name = "Compass Request Tracker"
...
compass_campaign_name =  column_map['Compass Campaign Name']
...
compass_tracker_path = 'C:\\Users\\phsheari\\Documents\\Compass Trackers\\'

trkr = pd.read_excel(compass_tracker_path + compass_tracker_filename, sheet_name=0)

print("Applying the Compass Tracker Data filter criteria! \n")

#dataframe filter criteria:
condition1 = (trkr['Compass Campaign Name']=='ProActive - EMEAR.1')
...
#trkr.loc[(condition1),'Compass Campaign Name'] = 'ReActive - EMEAR-PILOT'
...
requestids_to_update = trkr.loc[(condition1),'Request ID']
...
def evaluate_row_and_build_updates(source_row):
    ...
    # Build new cell value
        ...
        new_cell.column_id = column_map["Compass Campaign Name"]
        new_cell.value = 'ReActive - EMEAR-PILOT'
...
# Accumulate rows needing updates here
rows_to_update = []
